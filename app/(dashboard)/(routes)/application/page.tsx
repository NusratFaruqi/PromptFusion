...
import { MessageCircle, MessageSquare, ScrollText, Send } from "lucide-react";
  ...
  return (
    <div className="bg-gradient-to-r from-slate-700 via-stone-900 to-slate-800 h-full py-4 relative">
      <Heading
        ...
        description="Write job application seamlessly"
        icon={ScrollText}
      ...
      <div className="px-4 lg:px-8 ">
        <div className="space-y-4 mt-4">
          {messages.length === 0 && !isLoading && (
            <Empty label="No Application has been made." />
          )}
          {isLoading && (
                ...
                <FormItem className="col-span-12 lg:col-span-8 ">
                  <FormControl className="m-0 p-0">
                    <Input
                      ...
                      disabled={isLoading}
                      placeholder="Introduce yourself including your skills and expertise,education,hobby,experience etc"
                      {...field}
                    />
                  </FormControl>
                </FormItem>
